...
<div class="wrapper col1">
  <div id="container">
    <div id="content">
      <h1>Welcome to Munirat Clinic & Maternity, Mutum-Biyu</h1>
      <p>  The goal of the Munirat Clinic & Maternity, Mutum-Biyu
...
.</p>
      <p>The main feature of E-Knowledge in Munirat Clinic & Maternity, Mutum-Biyu is to provide the browser to get appointments from a doctor through internet instead of going there and fixing an appointment..</p>
      <p>	Everyone needs to have Medical attention at any time. So we allow every user to register freely at any time..</p>
      <p>Munirat Clinic & Maternity, Mutum-Biyu maintains patient's prescriptions so that their medical details are always available in Internet, which will be more convenient for the patients. This will be more comfortable for the patient..</p>
